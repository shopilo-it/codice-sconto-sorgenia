#!/usr/bin/env python3
"""
Recupero codici sconto Sorgenia da shopilo.it
Sursa: https://shopilo.it/negozi/sorgenia.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/sorgenia.it"
STORE_NAME = "Sorgenia"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Sorgenia da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-sorgenia)"
    }
    try:
